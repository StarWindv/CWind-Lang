"""Fancy rendering of CWind frontend errors using ariadne_py-py.

The rendering layer mirrors the Rust ``ariadne_py`` API: a :class:`LexError`
...
try:  # imported as part of the frontend package (from frontend.errors import ...)
    from .lexer import LexError
except ImportError:  # running as a plain script with frontend/ on sys.path
    from lexer import LexError
...
def render_error(
    ...
    *,
    ...
    """Render a :class:`LexError` as an ariadne_py diagnostic string.
    ...
    # ariadne_py's in-line style tags (same mechanism as the Rust crate's
