...
| ⬜   | 25   | `String.format`函数会将过长数值自动截断到(整数位数+小数位数=6位)                                                                                         |
| ⬜   | 26   | `String.format`函数在格式化自定义结构体对象时后端静默崩溃                                                                                                |
| ⬜   | 27   | `String.format`函数在格式化自定义结构体对象时前端没有调用对应的`Display::to_string`                                                                      |
| ⬜   | 28   | SA 没有验证待`format`对象是否实现了`Display`                                                                                                             |
