...
# POSIX 进程退出码只保留低 8 位 (283 -> 27); Windows 完整保留。
# 被比较的期望值按平台截断; 信号终止时 rc 是描述串, 原样比较。
if(NOT WIN32)
    math(EXPR _rc_expected "${EXPECTED_RC} % 256")
else()
    set(_rc_expected "${EXPECTED_RC}")
endif()
if(NOT rc EQUAL ${_rc_expected})
...
if(DEFINED EXPECTED_OUTPUT)
    ...
    set(_i 0)
    # IN LISTS: 未加引号的 ${exp_lines} 展开会在 CMake 4 下丢弃空元素
    # (期望输出里的空行无法对拍)
    foreach(_e IN LISTS exp_lines)
